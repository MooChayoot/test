...
function pvdoyswit() {
  ...
  // $(".pvdoy-pp").on("click touchstart", function () {
  //   let a = $(this).attr("id");
  //   if (a === "1") {
...
function RenderIframe(url_youtube) {
  let html = "";
  html +=
    '<iframe class="vdoypopup-ch" id="pop1" width="100%" height="100%" data-src="' +
    url_youtube +
...
function popup() {
  ...
  $(".ppypop").click(function () {
    ...
    $(this).parents("body").find(".popup-main").css({ visibility: "visible" });
    $(this)
      .parents("body")
...
function popupmunti() {
  $(".poppvdoy-pp").unbind("click");
  $(".poppvdoy-pp").click(function () {
    let linksrc = $(this).parent().find(".poppvdoy-vdo-ch").data("src");

    // let mainId = "a" + $(this).parent().attr("id");
    // let secId = "a" + $(this).parent().find(".poppvdoy-vdo-ch").attr("id");

    // if (player_youtube[idpop]!== undefined) {
    //   player_youtube[idpop].destroy()
    // }
    // $(this)
    //   .parents("body")
